...
<body>
<h1 class="text-center mb-4">Tambah Data Tuan Marsanti</h1>
...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <div class="card">
                <div class="card-body">
                    <form action="/inserttm" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if(count($errors) > 0)
                        ...
                        <a href="/tuan-marsanti" type="button" class="btn btn-danger">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
