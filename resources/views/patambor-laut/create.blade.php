...
<body>
<h1 class="text-center mb-4">Tambah Data Patambor Laut</h1>
...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <div class="card">
                <div class="card-body">
                    <form action="/insertpl" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if(count($errors) > 0)
                        ...
                        <a href="/patambor-laut" type="button" class="btn btn-danger">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
